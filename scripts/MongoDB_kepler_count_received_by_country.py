...
collection = db.APT_Total_incident_received_by_country_table
docs = collection.find()

new_collection = db.Kepler_APT_Total_incident_received_by_country
...
for header in docs[0].keys():
    ...
    if header != "_id":
        ...
        if header == "latitude":
            ...
            field_dict["format"] = ""
            field_dict["type"] = "real"
        elif header == "incidents_received":
            field_dict["format"] = ""
