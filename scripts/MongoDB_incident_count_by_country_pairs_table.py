...
new_collection = db.APT_Total_incidents_by_country_pairs_table

incidents_by_collection = db.APT_Total_incidents_by_country_pairs
...
for doc in collection_docs:
    if doc['cameo_country'] != "Unknown":
            ...
            for country2_code in doc['cameo_operation_countries']:
                ...
                ident = country1_code+"_"+country2_code
                
                if ident not in country_pairs:

                    country_pairs.append(country1_code+"_"+country2_code)
